...
/** Conceptos alineados a gastronomía + operación del local. */
export const DEFAULT_CONCEPTS: Array<{ name: string; kind: ConceptKind }> = [
  ...
  { name: 'Quesería', kind: ConceptKind.EXPENSE },
  { name: 'Carnicería', kind: ConceptKind.EXPENSE },
  { name: 'Pescadería', kind: ConceptKind.EXPENSE },
  { name: 'Panadería', kind: ConceptKind.EXPENSE },
  { name: 'Fiambrería', kind: ConceptKind.EXPENSE },
  { name: 'Almacén / secos', kind: ConceptKind.EXPENSE },
  { name: 'Lácteos', kind: ConceptKind.EXPENSE },
  { name: 'Huevos', kind: ConceptKind.EXPENSE },
  { name: 'Congelados', kind: ConceptKind.EXPENSE },
  { name: 'Aceites y condimentos', kind: ConceptKind.EXPENSE },
  { name: 'Bebidas', kind: ConceptKind.EXPENSE },
  { name: 'Cerveza y bar', kind: ConceptKind.EXPENSE },
  { name: 'Café', kind: ConceptKind.EXPENSE },
  { name: 'Heladería / postres', kind: ConceptKind.EXPENSE },
  { name: 'Materia prima', kind: ConceptKind.EXPENSE },
  { name: 'Insumos cocina', kind: ConceptKind.EXPENSE },
  ...
  { name: 'Comida staff', kind: ConceptKind.EXPENSE },
