 ...
 * - resolveShopBusinessDate: día laboral con openingTime (cierres y presentismo de servicio)
 */
...
/** Siguiente día calendario YYYY-MM-DD. */
...
export function formatBusinessDayHint(
  ...
  const [y1, m1, d1] = businessDate.split('-');
